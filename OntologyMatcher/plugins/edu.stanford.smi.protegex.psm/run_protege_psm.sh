...
JARS=protege.jar:driver.jar:driver1.jar:looks.jar:unicode_panel.jar:plugins/edu.stanford.smi.protegex.psm/tcl.jar:plugins/edu.stanford.smi.protegex.psm/jacl.jar
